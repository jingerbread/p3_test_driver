                                        ...
                                        for consumerPerSubscription in [partitionsPerTopic]:
                                            for ackQuorum in [2]:   # 2 causes OOM in Bookie at max rate
                                                ...
                                                t = dict(
                                                    ...
                                                    result_filename_long_s='data/results/json/%(test)s__%(messageSize)s__%(test_uuid)s.json',
                                                    result_filename_long_d='data/results/json/%(test)s__%(messageSize)d__%(test_uuid)s.json',
