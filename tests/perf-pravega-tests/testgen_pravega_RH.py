    ...
    for producerWorkers in [2]:
        ...
        for testDurationMinutes in [2]:
            for messageSize in [10000]:
                for producerRateEventsPerSec in [48e4, 1e3, 1e4, 6e3, 3e3, 5e3, 45e3, 9e3, 4e4, 15e3, 3e4, 25e3, 35e3, 2e4]:
                    for topics in [4]:
...
for repeat in range(1):
    for producerWorkers in [2]:
        ...
        for testDurationMinutes in [2]:
            for messageSize in [10000]:
                for producerRateEventsPerSec in [48e3, 1e3, 1e4, 6e3, 3e3, 5e3, 45e3, 9e3, 4e4, 15e3, 3e4, 25e3, 35e3, 2e4]:
                    for topics in [4]:
