...
echo -e "\e[36mtime tests/perf-pulsar-tests/testgen_pulsar_2.5.2aws_ssh.py -vv | p3_test_driver -t - -c config/pulsar_ssh.config.yaml\e[0m" # Takes ~45 min (1min test)
