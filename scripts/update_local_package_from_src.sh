...
set +x
echo -e "\e[35mUpdate finished successfully\e[0m"
echo -e "\e[34mRun test with f.e:\e[0m"
# Takes ~ >= 90 min
echo -e "\e[36mtests/testgen_pulsar_ssh.py -vv | p3_test_driver -t - -c config/pulsar_ssh.config.yaml\e[0m"
